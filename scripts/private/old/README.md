...
folder `tomas-faces-snapshots`, which then contains an additional folder called `sandbox`.
...
- **snaphot.sh**: Run this script to generate the `tomas-faces-snapshots` folder, containing
